...
<body>
    ...
    <form action="">
        <div class="containerMain" style="min-height: 630px;">
            <div class="sidebar">
                <?php
                    ...
                    <form id="form">
                        ...
                        <div class="container">
                            ...
                            <button type="button" id="resetform" class="btn btn-warning mx-1 Reset"
                                style="padding: 6px 10px;border-radius: 7px;" onClick="document.location.reload(true)">Reset</button>
...
// document ready file starts here...
    $('.getData').hide();
