...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    // echo $course_level;
     ...
     $sql = "INSERT INTO `courses` ( `deptt_name`, `course_name`, `course_code`, `duration`, `level`) VALUES ( '$Deptt_name', '$course_Name', '$course_Code', '$course_Duration', '$course_level')";
    ...
    {
        $Error = 'Unable to Add new Course. Try again';
    }
            ...
            <div class="container">
                ...
                <form action="<?php $_SERVER['PHP_SELF'];?>" method="POST" id="form">
                    <div class="text-center my-4"><u>
                            <h2 class="heading">New Course </h2>
                        </u></div>
                    <div class="mb-3 row">
                        <label for="name" class="col-sm-3 col-form-label">Name of Department</label>
                        <div class="col-md-8">
                            <?php
                        // linking database and fetching departments dynamically 
                            include '../partials/_dbconnect.php';
                        ...
                        ?>
                            ...
                            <select name="Deptt_name" class="departmentSelect" required>
                    ...
                    <div class="mb-3 row">
                        <label for="name" class="col-sm-3 col-form-label">Name of Course</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="name" name="course_Name" placeholder=""
                                required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="code" class="col-sm-3 col-form-label">Code of Course</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="name" name="course_Code" placeholder=""
                                required>
                        </div>
                    </div>

                    <div class="mb-3 row">
                        <label for="" class="col-sm-3 col-form-label">Course Duration</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="Course_Duration" name="course_Duration"
                                placeholder="2020-2022" required />
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="" class="col-sm-3 col-form-label">Level of Course</label>
                        <div class="col-sm-8">
                            <select name="course_Level" class="" required>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <button class="btn btn-sm btn-warning" id="resetform"> Reset </button>
